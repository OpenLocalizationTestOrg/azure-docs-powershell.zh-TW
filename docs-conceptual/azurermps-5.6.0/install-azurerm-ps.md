...
* [<span data-ttu-id="2fbc8-134">開始使用 Azure PowerShell</span><span class="sxs-lookup"><span data-stu-id="2fbc8-134">Get started with Azure PowerShell</span></span>](get-started-azureps.md)
