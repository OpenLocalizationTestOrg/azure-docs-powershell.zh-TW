...
1. <span data-ttu-id="bd63a-108">取得您帳戶中所有訂用帳戶的清單。</span><span class="sxs-lookup"><span data-stu-id="bd63a-108">Get a list of all subscriptions in your account.</span></span>
...
2. <span data-ttu-id="bd63a-109">預設設定。</span><span class="sxs-lookup"><span data-stu-id="bd63a-109">Set the default.</span></span>

    ```powershell
    Select-AzureRmSubscription -SubscriptionName "My Demos"
    ```

3. <span data-ttu-id="bd63a-110">執行 `Get-AzureRmContext` Cmdlet 來驗證變更。</span><span class="sxs-lookup"><span data-stu-id="bd63a-110">Verify the change by running the `Get-AzureRmContext` cmdlet.</span></span>
...
<span data-ttu-id="bd63a-111">一旦您設定預設訂用帳戶後，所有後續的 Azure PowerShell 命令都會對此訂用帳戶執行。</span><span class="sxs-lookup"><span data-stu-id="bd63a-111">Once you set your default subscription, all subsequent Azure PowerShell commands run against this subscription.</span></span>
