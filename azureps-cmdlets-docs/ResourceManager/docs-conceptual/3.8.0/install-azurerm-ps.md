...
---
# <a name="install-and-configure-azure-powershell"></a><span data-ttu-id="323eb-103">安裝並設定 Azure PowerShell</span><span class="sxs-lookup"><span data-stu-id="323eb-103">Install and configure Azure PowerShell</span></span>
...
## <a name="step-1-install-powershellget"></a><span data-ttu-id="323eb-105">步驟 1：安裝 PowerShellGet</span><span class="sxs-lookup"><span data-stu-id="323eb-105">Step 1: Install PowerShellGet</span></span>
...
## <a name="step-2-install-azure-powershell"></a><span data-ttu-id="323eb-113">步驟 2：安裝 Azure PowerShell</span><span class="sxs-lookup"><span data-stu-id="323eb-113">Step 2: Install Azure PowerShell</span></span>
...
## <a name="step-3-load-the-azurerm-module"></a><span data-ttu-id="323eb-124">步驟 3︰載入 AzureRM 模組</span><span class="sxs-lookup"><span data-stu-id="323eb-124">Step 3: Load the AzureRM module</span></span>
...
## <a name="next-steps"></a><span data-ttu-id="323eb-128">後續步驟</span><span class="sxs-lookup"><span data-stu-id="323eb-128">Next Steps</span></span>
...
## <a name="frequently-asked-questions"></a><span data-ttu-id="323eb-131">常見問題集</span><span class="sxs-lookup"><span data-stu-id="323eb-131">Frequently asked questions</span></span>

### <a name="how-to-get-powershellget"></a><span data-ttu-id="323eb-132">如何取得 PowerShellGet</span><span class="sxs-lookup"><span data-stu-id="323eb-132">How to get PowerShellGet</span></span>
...
<a id="helpmechoose"></a>
### <a name="checking-the-version-of-azure-powershell"></a><span data-ttu-id="323eb-141">檢查 Azure PowerShell 的版本</span><span class="sxs-lookup"><span data-stu-id="323eb-141">Checking the version of Azure PowerShell</span></span>
...
### <a name="support-for-classic-deployment-methods"></a><span data-ttu-id="323eb-144">對於傳統部署方法的支援</span><span class="sxs-lookup"><span data-stu-id="323eb-144">Support for classic deployment methods</span></span>
...
### <a id="update-azps"></a><span data-ttu-id="323eb-149">更新為新版的 Azure PowerShell</span><span class="sxs-lookup"><span data-stu-id="323eb-149">Updating to a new version of Azure PowerShell</span></span>
...
### <a name="installing-module-versions-side-by-side"></a><span data-ttu-id="323eb-154">並存安裝模組版本</span><span class="sxs-lookup"><span data-stu-id="323eb-154">Installing module versions side by side</span></span>
...
### <a name="other-installation-methods"></a><span data-ttu-id="323eb-163">其他安裝方法</span><span class="sxs-lookup"><span data-stu-id="323eb-163">Other installation methods</span></span>
